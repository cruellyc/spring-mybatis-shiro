(function(){
        ...
        H5lock.prototype.storePass = function(psw) {// touchend结束之后对密码和状态的处理
            if (this.pswObj.step == 1) {
                if (this.checkPass(this.pswObj.fpassword, psw)) {
                    ...
                    //document.getElementById('title').innerHTML = '设置成功';
                    ...
                    //document.getElementById('title').innerHTML = '两次手势不一致';
                	SD.toast('两次手势不一致');
                ...
                if (this.checkPass(this.pswObj.spassword, psw)) {
                    document.getElementById('title').innerHTML = '请输入新手势';
                    this.drawStatusPoint('#2CFF26');
                    this.updatePassword();
                } else {
                    this.drawStatusPoint('red');
                    /*document.getElementById('title').innerHTML = '手势错误';*/
                    SD.toast('手势错误');
                }
            } else {
                this.pswObj.step = 1;
                this.pswObj.fpassword = psw;
                document.getElementById('title').innerHTML = '请再次输入手势';
            }
        ...
        H5lock.prototype.makeState = function() {
            if (this.pswObj.step == 2) {
                ...
                //document.getElementById('title').innerHTML = '请滑动设置手势密码';
        ...
        H5lock.prototype.initDom = function(){
            ...
            var str = '<div id="title" class="index_title">请输入手势</div>'+
                      '<a id="updatePassword" style="position: absolute;right: 5px;top: 5px;color:#fff;font-size: 10px;display:none;">重置密码</a>'+
                      '<canvas id="canvas" width="300" height="300" style="display: inline-block;"></canvas>'+
                      '<div class="index_title2"></div>';
            $('.index_gesture').append(str);
        }
